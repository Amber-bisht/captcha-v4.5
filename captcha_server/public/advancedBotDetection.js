 ...
 */
(function () {
    async function detectBotSignals() {
        const nav = navigator;
        const win = window;
        const webdriver = !!(nav.webdriver ||
        ...
        try {
            chromeRuntime = !!(win.chrome && win.chrome.runtime);
        }
        catch { }
    ...
    window.detectBotSignals = detectBotSignals;
})();
