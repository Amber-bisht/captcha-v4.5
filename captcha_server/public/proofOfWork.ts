...
(function () {
    ...
    async function solveProofOfWork(challenge: PoWChallengeInput): Promise<PoWSolutionResult> {
    ...
    (window as any).solveProofOfWork = solveProofOfWork;
})();
